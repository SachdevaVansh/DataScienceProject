...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config=TrainingPipelineConfig):
        ...
        self.preprocessed_object_file_path: str =os.path.join(self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR, training_pipeline.PREPROCESSED_OBJECT_FILE_NAME)  
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config=TrainingPipelineConfig):
        ...
        self.excepected_score: float=training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
